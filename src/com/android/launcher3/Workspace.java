...
public class Workspace extends PagedView<WorkspacePageIndicator>
    ...
    /**
     * 在删除所有页面之前禁用所有布局过渡，以确保我们不会在添加页面时获得与我们更改滚动条的过渡动画竞争
     */
...
//        }
    ...
    /**
     * 在绑定时，我们使用 rank （screenId） 来计算热座项目的 x 和 y
     * 绑定完成后的添加
...
//        addInScreen(child, info.container, info.screenId, x, y, info.spanX, info.spanY);
    ...
    /**
     * 在指定的屏幕中添加指定的子项。子项的位置和维度由 x、y、spanX 和 spanY 定义
