...
public class LhmGridOccupancy {
    ...
    public LhmGridOccupancy(int countX, int countY) {
        mCountX = countX;
        mCountY = countY;
    ...
    public void copyTo(LhmGridOccupancy dest) {
    ...
    public void markCells(LhmCellAndSpan cell, boolean value) {
