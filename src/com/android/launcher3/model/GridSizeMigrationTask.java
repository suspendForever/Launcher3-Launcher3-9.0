...
public class GridSizeMigrationTask {
    ...
    public static boolean migrateGridIfNeeded(Context context) {
        ...
        String migrationSrcWorkSpaceSizeStr = prefs.getString(KEY_MIGRATION_SRC_WORKSPACE_SIZE, "");
        LogUtil.d(TAG, "migrateGridIfNeeded: migrationSrcWorkSpaceSizeStr:" + migrationSrcWorkSpaceSizeStr);
        if (gridSizeString.equals(migrationSrcWorkSpaceSizeStr) &&
